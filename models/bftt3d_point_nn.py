...
from .bftt3d_model_utils import *
import random
import math
...
class FPS_kNN(nn.Module):
    ...
    def forward(self, xyz, x):
        ...
        fps_idx = sample_farthest_points(xyz, K=self.group_num)[1].long() # pytorch3d
        ...
        # kNN
        knn_idx = knn_points(lc_xyz, xyz, K=self.k_neighbors)[1]  # pytorch3d
